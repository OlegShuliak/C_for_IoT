...
//.....        
        ...
        */
            ...
            char* get_str_on1 = strstr(buffer, "/LED1 - on");
            char* get_str_on2 = strstr(buffer, "/LED2 - on");
            char* get_str_off1 = strstr(buffer, "/LED1 - off");
            char* get_str_off2 = strstr(buffer, "/LED2 - off");
            
            if (get_str_on1) {printf("%s/n", get_str_on1);}
            if (get_str_on2) {printf("%s/n", get_str_on2);}
            if (get_str_off1) {printf("%s/n", get_str_off1);}
            if (get_str_off2) {printf("%s/n", get_str_off2);}
